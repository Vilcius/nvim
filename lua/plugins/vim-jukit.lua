...
-- FIX: Make sure the keymaps are defined correctly.
-- TODO: Set localleader to "\" and redefine the keymaps.
...
vim.keymap.set('n', '<C-PageUp>', "<cmd>call jukit#cells#jump_to_previous_cell()<CR>zz",
