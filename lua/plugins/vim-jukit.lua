...
return {
  "luk400/vim-jukit",
  keys = {
    { "<C-PageDown>", "<cmd>call jukit#cells#jump_to_next_cell()<CR>zz",     desc = "Jump to next cell" },
    { "<C-PageUp>",   "<cmd>call jukit#cells#jump_to_previous_cell()<CR>zz", desc = "Jump to previous cell" },
